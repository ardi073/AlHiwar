  ...
  return (
    <footer className="absolute bottom-0 w-full px-4 sm:px-6 py-6 pb-8 bg-gradient-to-t from-slate-50 via-slate-50/95 to-transparent z-30 pointer-events-none">
      <div className="max-w-3xl mx-auto flex flex-col md:flex-row items-center justify-between relative gap-6 md:gap-0 pointer-events-auto">
        ...
        {/* Status Indicator */}
        <div className="flex items-center gap-3 px-4 py-2.5 rounded-2xl bg-white dark:bg-slate-900/80 backdrop-blur-md shadow-sm border border-slate-200 dark:border-slate-700/80 w-auto md:flex-1 md:max-w-[200px]">
          {isLive ? (
            <div className="relative flex h-3 w-3">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-3 w-3 bg-blue-50 dark:bg-blue-9500 shadow-[0_0_8px_rgba(59,130,246,0.8)]"></span>
            </div>
          ) : isConnecting ? (
            <div className="relative flex h-3 w-3">
        ...
        <div className="w-auto md:flex-1 md:max-w-[200px] flex justify-center md:justify-end gap-3">
          <button className="flex items-center justify-center w-12 h-12 text-slate-500 dark:text-slate-400 hover:text-blue-600 bg-white dark:bg-slate-900/80 hover:bg-white dark:bg-slate-900 rounded-2xl transition-all duration-300 shadow-sm border border-slate-200 dark:border-slate-700/80 hover:-translate-y-1 hover:shadow-md">
